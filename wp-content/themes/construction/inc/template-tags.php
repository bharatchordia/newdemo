...
function wpcharming_get_page_title($postID) {
    ...
    if ( isset( $wpc_option['page_contact_button'] )) {
	...
	if ( isset( $admin_button_onoff ) && 1 == $admin_button_onoff ) {
		if ( !empty( $admin_button_pages ) && is_page( $admin_button_pages ) ) $display = true;
	}
